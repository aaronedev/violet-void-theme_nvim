...
function M.get(c, opts)
  ...
  return {
    ...
    WinSeparator                = { fg = c.bg_dark1, bold = true }, -- the column separating vertically split windows
    ...
    NonText                     = { fg = c.dark3 }, -- '@' at the end of the window, characters from 'showbreak'
    -- and other characters that do not really exist in the text (e.g., ">" displayed when a
    -- double-wide character doesn't fit at the end of the line). See also |hl-EndOfBuffer|.
    ...
    IncSearch                   = { bg = Util.blend_bg(c.orange, 0.2), fg = c.fg }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
    CurSearch                   =  "IncSearch",
    SpecialKey                  = { fg = c.dark3 }, -- Unprintable characters: text displayed differently from what it really is.  But not 'listchars' whitespace. |hl-Whitespace|
    SpellBad                    = { sp = c.error, undercurl = true }, -- Word that is not recognized by the spellchecker. |spell| Combined with the highlighting used otherwise.
    SpellCap                    = { sp = c.warning, undercurl = true }, -- Word that should start with a capital. |spell| Combined with the highlighting used otherwise.
    SpellLocal                  = { sp = c.info, undercurl = true }, -- Word that is recognized by the
    -- spellchecker as one that is used in another region. |spell| Combined with the highlighting used otherwise.
    SpellRare                   = { sp = c.hint, undercurl = true }, -- Word that is recognized by the
    -- spellchecker as one that is hardly ever used. |spell| Combined with the highlighting used otherwise.
    StatusLine                  = { fg = c.fg_sidebar, bg = c.bg_statusline }, -- status line of current window
    StatusLineNC                = { fg = c.fg_gutter, bg = c.bg_statusline }, -- status lines of not-current
    -- windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
    TabLine                     = { bg = c.bg_statusline, fg = c.fg_gutter }, -- tab pages line, not active tab page label
    TabLineFill                 = { bg = c.black }, -- tab pages line, where there are no labels
    TabLineSel                  = { fg = c.black, bg = c.blue }, -- tab pages line, active tab page label
    Title                       = { fg = c.blue, bold = true }, -- titles for output from ":set all", ":autocmd" etc.
    Visual                      = { bg = Util.blend_bg(c.blue7, 0.14)}, -- Visual mode selection
    ...
    Boolean                     = { fg = c.purple, style = opts.styles.booleans }, -- a boolean constant: TRUE, false
    ...
    LspInlayHint                = { bg = Util.blend_bg(c.bg_visual, 0.1), fg = c.fg_float},
    ...
    DiagnosticVirtualTextWarn   = { bg = c.none,  fg = Util.blend_fg(c.orange, 1) }, -- Used for "Warning" diagnostic virtual text
