...
function M.get(c, opts)
  ...
  local ret = {
    ...
    ["@markup.math"]                = "Special",
    ["@markup.raw"]                 = "String",
    ["@markup.raw.markdown_inline"] = { bg = c.terminal_black, fg = c.blue5 },
    ...
    ["@conceal.json"]               = { fg = Util.blend_fg(c.green1, 0.44)},
    ["@string.ini"]                 = { fg = c.magenta},
    ["@string.toml"]                 = { fg = c.blue5},
    ["@operator.toml"]                 = { fg = c.green1},
    -- ["@boolean.toml"]
  }
